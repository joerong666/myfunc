...
class Logger(Singleton):
    ...
    def _setup_handlers(self, logfilepath="%s/var/log/certmaster/certmaster.log" % conf_dir):
...
class AuditLogger(Singleton):
    _no_handlers = True
    def __init__(self, logfilepath = "%s/var/log/certmaster/audit.log" % conf_dir):
    ...
    def _setup_handlers(self, logfilepath="%s/var/log/certmaster/audit.log" % conf_dir):
        handler = logging.FileHandler(logfilepath, "a")
        self.logger.setLevel(self.loglevel)
